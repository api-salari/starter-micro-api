...
app.poat("/send/message", async (req, res) => {
    ...
    try {
        const result = await axios.get("https://api.telegram.org/bot6957778956:AAEcxQpdOMfTTKcGe0CPtfPBuZ0GzCwSaTU/sendMessage?chat_id=5861988128&text="+String(text));
